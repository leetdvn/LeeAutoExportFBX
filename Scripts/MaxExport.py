...
class MassExportFbx():
    ...
    def __init__(self) -> None:
        self.ExportDir=str('C:/Users/thang/Documents/Exports/Kun_GLX_SS2_Ep11_Shot043_HIJK_F_V2/{fName}')
        self.ScriptDir=str('C:/Users/thang/AppData/Local/LeeMassFbx/Scripts/{py}')
